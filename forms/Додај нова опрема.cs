...
{
    public partial class Додај_нова_опрема : Form
    {
        public Додај_нова_опрема()
        {
            InitializeComponent();
        }
        ...
        private void Додај_нова_опрема_Load(object sender, EventArgs e)
        {
            this.Width = 1000;
            this.Height = 600;
            this.ShowIcon = false;
            ...
            lbID.Text = "Внеси ID број";
            lbID.Width = 150;
            lbID.TextAlign = ContentAlignment.MiddleCenter;
            lbID.ForeColor = Color.Black;
            lbID.Font = new Font("Calibri", 10);
            lbID.Location = new Point(50, 100);
            panel2.Controls.Add(lbID);

            Label lbIme = new Label();
            lbIme.Text = "Внеси Име";
            lbIme.TextAlign = ContentAlignment.MiddleCenter;
            lbIme.Width = 150;
            lbIme.ForeColor = Color.Black;
            lbIme.Font = new Font("Calibri", 10);
            lbIme.Location = new Point(50, 150);
            panel2.Controls.Add(lbIme);

            Label lbKol = new Label();
            lbKol.Text = "Внеси Количина";
            lbKol.Width = 150;
            lbKol.TextAlign = ContentAlignment.MiddleCenter;
            lbKol.ForeColor = Color.Black;
            lbKol.Font = new Font("Calibri", 10);
            lbKol.Location = new Point(50, 200);
            panel2.Controls.Add(lbKol);

            Label lbCena = new Label();
            lbCena.Text = "Внеси Цена";
            lbCena.Width = 150;
            lbCena.TextAlign = ContentAlignment.MiddleCenter;
            lbCena.ForeColor = Color.Black;
            lbCena.Font = new Font("Calibri", 10);
            lbCena.Location = new Point(50, 250);
            panel2.Controls.Add(lbCena);
            
            tbID.Width = 350;
            tbID.Location = new Point(200, 100);
            panel2.Controls.Add(tbID);
            
            tbIme.Width = 350;
            tbIme.Location = new Point(200, 150);
            panel2.Controls.Add(tbIme);
           
            tbKol.Width = 350;
            tbKol.Location = new Point(200, 200);
            panel2.Controls.Add(tbKol);
            
            tbCena.Width = 350;
            tbCena.Location = new Point(200, 250);
            panel2.Controls.Add(tbCena);
            
            bt1.Text = "Зачувај";
            bt1.ForeColor = Color.Black;
            bt1.Width = 100;
            bt1.Height = 30;
            bt1.Location = new Point(250, 350);
        ...
        {
            if (tbID.Text != "" && tbIme.Text != "" &&  tbKol.Text != "" && tbCena.Text != "" )
            {
                conn.Open();
                string query = "insert into Oprema(OpremaID,Ime,Kolichina,Cena) " +
                    "values (@tbID ,@tbIme,@tbKol ,@tbCena)";
                SqlCommand cmd = new SqlCommand(query, conn);            
                cmd.Parameters.AddWithValue("@tbID", tbID.Text);
                cmd.Parameters.AddWithValue("@tbIme", tbIme.Text);
                cmd.Parameters.AddWithValue("@tbKol", tbKol.Text);
