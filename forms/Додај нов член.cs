...
{
    public partial class Додај_нов_член : Form
    {
        public Додај_нов_член()
        {
            InitializeComponent();
        }
        ...
        TextBox tbPol = new TextBox();
        TextBox tbDOB = new TextBox();
        TextBox tbAdresa = new TextBox();
        ...
        private void Додај_нов_член_Load(object sender, EventArgs e)
        {
            this.Width = 1000;
            this.Height = 600;
            this.ShowIcon = false;
            ...
            lbPrezime.Width = 100;
            lbPrezime.TextAlign = ContentAlignment.MiddleRight;
            lbPrezime.ForeColor = Color.Black;
            lbPrezime.Font = new Font("Calibri", 10);
            lbPrezime.Location = new Point(70, 150);
            panel1.Controls.Add(lbPrezime);

            Label lbPol = new Label();
            lbPol.Text = "Внеси Пол";
            lbPol.Width = 100;
            lbPol.TextAlign = ContentAlignment.MiddleRight;
            lbPol.ForeColor = Color.Black;
            lbPol.Font = new Font("Calibri", 10);
            lbPol.Location = new Point(70, 200);
            panel1.Controls.Add(lbPol);

            Label lbDOB = new Label();
            lbDOB.Text = "Внеси Датум на Раѓање";
            lbDOB.Width = 150;
            lbDOB.TextAlign = ContentAlignment.MiddleRight;
            lbDOB.ForeColor = Color.Black;
            lbDOB.Font = new Font("Calibri", 10);
            lbDOB.Location = new Point(20, 250);
            panel1.Controls.Add(lbDOB);

            Label lbAdr = new Label();
            lbAdr.Text = "Внеси Адреса";
            lbAdr.Width = 100;
            lbAdr.TextAlign = ContentAlignment.MiddleRight;
            lbAdr.ForeColor = Color.Black;
            lbAdr.Font = new Font("Calibri", 10);
            lbAdr.Location = new Point(70, 300);
            panel1.Controls.Add(lbAdr);

            Label lbTel = new Label();
            lbTel.Text = "Внеси Телефон";
            lbTel.Width = 100;
            lbTel.TextAlign = ContentAlignment.MiddleRight;
            lbTel.ForeColor = Color.Black;
            lbTel.Font = new Font("Calibri", 10);
            lbTel.Location = new Point(70, 350);
            ...
            tbPrezime.Width = 350;
            tbPrezime.Location = new Point(200, 150);
            panel1.Controls.Add(tbPrezime);
            
            tbPol.Width = 350;
            tbPol.Location = new Point(200, 200);
            panel1.Controls.Add(tbPol);
            
            tbDOB.Width = 350;
            tbDOB.Location = new Point(200, 250);
            panel1.Controls.Add(tbDOB);
            
            tbAdresa.Width = 350;
            tbAdresa.Location = new Point(200, 300);
            panel1.Controls.Add(tbAdresa);
            
            tbTel.Width = 350;
            tbTel.Location = new Point(200, 350);
            ...
            bt1.Width = 100;
            bt1.Height = 30;
            bt1.Location = new Point(250, 420);
        ...
        {
            if (tbIme.Text != "" && tbPrezime.Text != "" && tbPol.Text != "" && tbDOB.Text != "" && tbAdresa.Text != "" && tbTel.Text != "" )
            {
                conn.Open();
                string query = "insert into Chlenovi(Ime,Prezime,Pol,[Datum Rag],Adresa,Telefon) " +
                    "values (@tbIme,@tbPrezime ,@tbPol ,@tbDOB ,@tbAdresa,@tbTel)";
                SqlCommand cmd = new SqlCommand(query, conn);
                cmd.Parameters.AddWithValue("@tbIme", tbIme.Text);       
                cmd.Parameters.AddWithValue("@tbPrezime", tbPrezime.Text);
                cmd.Parameters.AddWithValue("@tbPol", tbPol.Text);
                cmd.Parameters.AddWithValue("@tbDOB", tbDOB.Text);
                cmd.Parameters.AddWithValue("@tbAdresa", tbAdresa.Text);
