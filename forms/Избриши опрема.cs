...
{
    public partial class Избриши_опрема : Form
    {
        public Избриши_опрема()
        {
            InitializeComponent();
        }
        ...
        private void Избриши_опрема_Load(object sender, EventArgs e)
        {
            this.Width = 1000;
            this.Height = 600;
            this.ShowIcon = false;
            ...
            conn.Open();
            dataAdapter = new SqlDataAdapter("select OpremaID AS РеденБрој, Ime AS Име, Kolichina AS Количина, Cena AS Цена from Oprema", conn);
            ...
            bt1.Click += new EventHandler(this.IzbrishiOprema_Click);
        ...
        public void IzbrishiOprema_Click(object sender, EventArgs e)
        {
            conn.Open();
            SqlCommand sql = new SqlCommand("DELETE FROM Oprema WHERE OpremaID = @tbrb", conn);
