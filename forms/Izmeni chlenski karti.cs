...
{
    public partial class Izmeni_chlenski_karti : Form
    {
        public Izmeni_chlenski_karti()
        {
            InitializeComponent();
        }
        ...
        private void Izmeni_chlenski_karti_Load(object sender, EventArgs e)
        {
            this.Width = 1000;
            this.Height = 600;
            this.ShowIcon = false;
        ...
        public void Zachuvaj_Click(object sender, EventArgs e)
        {
            ...
            {
                conn.Open();
                string query = "Update Chlenski_Karti set Ime=@tbNovoIme where ID = @tbrb";
            ...
            {
                conn.Open();
                string query = "Update Chlenski_Karti set Cena=@tbNovaCena where ID = @tbrb";
                SqlCommand cmd = new SqlCommand(query, conn);
                cmd.Parameters.Add("@tbrb", SqlDbType.Int).Value = Convert.ToInt32(tbrb.Text);
