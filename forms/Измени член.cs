...
{
    public partial class Измени_член : Form
    {
        public Измени_член()
        {
            InitializeComponent();
        ...
        private void Измени_член_Load(object sender, EventArgs e)
        {
            this.Width = 1000;
            this.Height = 600;
            this.ShowIcon = false;
            ...
            Label lb2 = new Label();
            lb2.Text = "Измени или избриши член";
            lb2.Width = 300;
            lb2.Height = 40;
            ...
            bt1.Click += new EventHandler(this.IzbrishiChlen_Click);
            ...
            bt2.Click += new EventHandler(this.IzmeniChlen_Click);
        ...
        public void IzbrishiChlen_Click(object sender, EventArgs e)
        {
            conn.Open();
            SqlCommand sql = new SqlCommand("DELETE FROM Chlenovi WHERE IDBroj = @tbrb", conn);
        ...
        public void IzmeniChlen_Click(object sender, EventArgs e)
        {
            this.Hide();
            Izmeni_Chlen_Izbor izmeniChlen = new Izmeni_Chlen_Izbor();
            izmeniChlen.FormClosed += (s, args) => this.Close();
            izmeniChlen.Show();
        }
    }
