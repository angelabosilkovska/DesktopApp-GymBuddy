...
{
    public partial class Членски_Карти : Form
    {
        public Членски_Карти()
        {
            InitializeComponent();
        }
        ...
        private void Членски_Карти_Load(object sender, EventArgs e)
        {
            this.Width = 1000;
            this.Height = 600;
            this.ShowIcon = false;
            ...
            Label lb1 = new Label();
            lb1.Text = "Приказ на сите типови членски карти";
            lb1.Width = 350;
            lb1.Height = 50;
            ...
            conn.Open();
            dataAdapter = new SqlDataAdapter("select ID AS РеденБрој, Ime AS Име, Cena AS Цена from Chlenski_Karti", conn);
            ...
            Label lb2 = new Label();
            lb2.Text = "Внесете Реден Број";
            lb2.Width = 150;
            lb2.TextAlign = ContentAlignment.MiddleLeft;
            lb2.ForeColor = Color.Black;
            lb2.Font = new Font("Calibri", 11);
            lb2.Location = new Point(50, 400);
            panel2.Controls.Add(lb2);
 
            tbrb.Width = 200;
            tbrb.Location = new Point(200, 400);
            ...
            bt1.Width = 100;
            bt1.Height = 30;
            bt1.Location = new Point(100, 450);
            bt1.Click += new EventHandler(this.IzbrishiUsluga_Click);
            ...
            bt2.Width = 100;
            bt2.Height = 30;
            bt2.Location = new Point(250, 450);
            bt2.Click += new EventHandler(this.IzmeniUsluga_Click);
            ...
            bt3.Width = 100;
            bt3.Height = 30;
            bt3.Location = new Point(400, 450);
            bt3.Click += new EventHandler(this.DodajUsluga_Click);
        ...
        public void IzbrishiUsluga_Click(object sender, EventArgs e)
        {
            conn.Open();
            SqlCommand sql = new SqlCommand("DELETE FROM Chlenski_Karti WHERE ID = @tbrb", conn);
            sql.Parameters.Add("@tbrb", SqlDbType.Int).Value = Convert.ToInt32(tbrb.Text);
            sql.ExecuteNonQuery();
            dataAdapter = new SqlDataAdapter("select ID AS РеденБрој, Ime AS Име, Cena AS Цена from Chlenski_Karti", conn);
        ...
        public void IzmeniUsluga_Click(object sender, EventArgs e)
        {
            this.Hide();
            Izmeni_chlenski_karti izchkarti = new Izmeni_chlenski_karti();
            izchkarti.FormClosed += (s, args) => this.Close();
            izchkarti.Show();
        }
        public void DodajUsluga_Click(object sender, EventArgs e)
        {
            this.Hide();
            Dodaj_Chlenski_Karti chkarti = new Dodaj_Chlenski_Karti();
            chkarti.FormClosed += (s, args) => this.Close();
            chkarti.Show();
        }
    }
}
