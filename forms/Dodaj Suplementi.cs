...
{
    public partial class Dodaj_Suplementi : Form
    {
        public Dodaj_Suplementi()
        {
            InitializeComponent();
        }
        ...
        private void Dodaj_Suplementi_Load(object sender, EventArgs e)
        {
            this.Width = 1000;
            this.Height = 600;
            this.ShowIcon = false;
        ...
        public void btZachuvaj_Click(object sender, EventArgs e)
        {
            ...
            {
                conn.Open();
                string query = "insert into Suplementi(ID,Ime,Cena) " +
