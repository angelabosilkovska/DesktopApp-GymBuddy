...
{
    public partial class Измени_вработен : Form
    {
        public Измени_вработен()
        {
            InitializeComponent();
        }
        ...
        private void Измени_вработен_Load(object sender, EventArgs e)
        {
            this.Width = 1000;
            this.Height = 600;
            this.ShowIcon = false;
            ...
            Label lb4 = new Label();
            lb4.Text = "Внесете реден број";
            lb4.Width = 150;
            lb4.TextAlign = ContentAlignment.MiddleLeft;
            lb4.ForeColor = Color.Black;
            lb4.Font = new Font("Calibri", 10);
            lb4.Location = new Point(50, 410);
            panel2.Controls.Add(lb4);

            tbrb.Width = 300;
            tbrb.Location = new Point(200, 410);
            ...
            bt1.Click += new EventHandler(this.IzbrishiVrab_Click);
            ...
            bt2.Click += new EventHandler(this.IzmeniVrab_Click);
        ...
        public void IzbrishiVrab_Click(object sender, EventArgs e)
        {
            conn.Open();
            SqlCommand sql = new SqlCommand("DELETE FROM Vraboteni WHERE VrabotenID = @tbrb", conn);
        ...
        public void IzmeniVrab_Click(object sender, EventArgs e)
        {
            this.Hide();
            Izmeni_Vrab_Izbor izmeniVrab= new Izmeni_Vrab_Izbor();
            izmeniVrab.FormClosed += (s, args) => this.Close();
            izmeniVrab.Show();
        }
    }
