...
{
    public partial class Персонализирани_тренизни : Form
    {
        public Персонализирани_тренизни()
        {
            InitializeComponent();
        }
        ...
        private void Персонализирани_тренизни_Load(object sender, EventArgs e)
        {
            this.Width = 1000;
            this.Height = 600;
            this.ShowIcon = false;
            ...
            Label lb1 = new Label();
            lb1.Text = "Приказ на сите типови персонализирани тренинзи";
            lb1.Width = 450;
            lb1.Height = 50;
        ...
        {
            conn.Open();
            SqlCommand sql = new SqlCommand("DELETE FROM Personalizirani_Treninzi WHERE ID = @tbrb", conn);
        ...
        {
            this.Hide();
            Izmeni_pTreninzi ptreninzi = new Izmeni_pTreninzi();
        ...
        {
            this.Hide();
            Dodaj_Presonalizirani_Treninzi ptrenizi = new Dodaj_Presonalizirani_Treninzi();
            ptrenizi.FormClosed += (s, args) => this.Close();
            ptrenizi.Show();
        }
    }
}
