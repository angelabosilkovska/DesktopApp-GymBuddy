...
{
    public partial class Суплементи : Form
    {
        public Суплементи()
        {
            InitializeComponent();
        ...
        private void Суплементи_Load(object sender, EventArgs e)
        {
            this.Width = 1000;
            this.Height = 600;
            this.ShowIcon = false;
            ...
            Label lb1 = new Label();
            lb1.Text = "Приказ на сите типови суплементи";
            lb1.Width = 350;
            lb1.Height = 50;
            ...
            conn.Open();
            dataAdapter = new SqlDataAdapter("select ID AS РеденБрој, Ime AS Име, Cena AS Цена from Suplementi", conn);
        ...
        {
            conn.Open();
            SqlCommand sql = new SqlCommand("DELETE FROM Suplementi WHERE ID = @tbrb", conn);
        ...
        {
            this.Hide();
            Izmeni_Suplementi suplementi = new Izmeni_Suplementi();
            suplementi.FormClosed += (s, args) => this.Close();
            suplementi.Show();
        }
        ...
        {
            this.Hide();
            Dodaj_Suplementi suplementi = new Dodaj_Suplementi();
            suplementi.FormClosed += (s, args) => this.Close();
            suplementi.Show();
        }
    }
