...
{
    public partial class Dodaj_Presonalizirani_Treninzi : Form
    {
        public Dodaj_Presonalizirani_Treninzi()
        {
            InitializeComponent();
        }
        ...
        private void Dodaj_Presonalizirani_Treninzi_Load(object sender, EventArgs e)
        {
            this.Width = 1000;
            this.Height = 600;
            this.ShowIcon = false;
            ...
            Label lb1 = new Label();
            lb1.Text = "Додај нов тип личен тренинг";
            lb1.Width = 300;
            lb1.Height = 50;
        ...
        public void btZachuvaj_Click(object sender, EventArgs e)
        {
            ...
            {
                conn.Open();
                string query = "insert into Personalizirani_Treninzi(ID,Ime,Cena) " +
        ...
        {
            this.Hide();
            Персонализирани_тренизни ptrenizi = new Персонализирани_тренизни();
