...
{
    public partial class Izmeni_Vrab_Izbor : Form
    {
        public Izmeni_Vrab_Izbor()
        {
            InitializeComponent();
        }
        ...
        TextBox tbNovoPrezime = new TextBox();
        TextBox tbNovaAdresa = new TextBox();
        TextBox tbNovTelefon = new TextBox();
        TextBox tbNovoKIme = new TextBox();
        TextBox tbNovEmail = new TextBox();
        ...
        private void Izmeni_Vrab_Izbor_Load(object sender, EventArgs e)
        {
            this.Width = 1000;
            this.Height = 600;
            this.ShowIcon = false;
            ...
            conn.Open();
            dataAdapter = new SqlDataAdapter("select VrabotenID AS РеденБрој, Ime AS Име, Prezime AS Презиме, [Korisnichko ime] AS КорисничкоИме, Telefon As Телефон, Adresa AS Адреса, [E-mail] AS Мејл, EMBG AS ЕМБГ from Vraboteni", conn);
            ...
            cbox.Items.Add("Презиме");
            cbox.Items.Add("Корисничко Име");
            cbox.Items.Add("Телефон");
            cbox.Items.Add("Адреса");
            cbox.Items.Add("Е-Маил");
            ...
            lb3.Text = "Измени Корисничко Име";
            lb3.Width = 300;
            lb3.Height = 40;
            ...
            lb4.Text = "Измени Телефон";
            lb4.Width = 250;
            lb4.Height = 40;
            lb4.ForeColor = Color.Black;
            lb4.Font = new Font("Calibri", 17);
            lb4.Location = new Point(150, 40);
            lb4.Hide();
            panel2.Controls.Add(lb4);

            lb9.Text = "Измени Адреса";
            lb9.Width = 250;
            lb9.Height = 40;
            lb9.ForeColor = Color.Black;
            lb9.Font = new Font("Calibri", 17);
            lb9.Location = new Point(150, 40);
            lb9.Hide();
            panel2.Controls.Add(lb9);

            lb6.Text = "Измени Е-Маил";
            lb6.Width = 250;
            lb6.Height = 40;
            lb6.ForeColor = Color.Black;
            lb6.Font = new Font("Calibri", 17);
            lb6.Location = new Point(150, 40);
            lb6.Hide();
            panel2.Controls.Add(lb6);
            ...
            tbNovoPrezime.Width = 200;
            tbNovoPrezime.Location = new Point(250, 110);
            tbNovoPrezime.Hide();
            panel2.Controls.Add(tbNovoPrezime);

            tbNovoKIme.Width = 200;
            tbNovoKIme.Location = new Point(250, 110);
            tbNovoKIme.Hide();
            panel2.Controls.Add(tbNovoKIme);

            tbNovTelefon.Width = 200;
            tbNovTelefon.Location = new Point(250, 110);
            tbNovTelefon.Hide();
            panel2.Controls.Add(tbNovTelefon);

            tbNovaAdresa.Width = 200;
            tbNovaAdresa.Location = new Point(250, 110);
            tbNovaAdresa.Hide();
            panel2.Controls.Add(tbNovaAdresa);

            tbNovEmail.Width = 200;
            tbNovEmail.Location = new Point(250, 110);
            tbNovEmail.Hide();
            panel2.Controls.Add(tbNovEmail);
        ...
        public void Izberi_Click(object sender, EventArgs e)
        {
            ...
            if (cbox.SelectedItem.Equals("Презиме"))
            {
                lb2.Show();
                tbNovoPrezime.Show();
            }
            if (cbox.SelectedItem.Equals("Корисничко Име"))
            {
                lb3.Show();
                tbNovoKIme.Show();
            }
            if (cbox.SelectedItem.Equals("Телефон"))
            {
                lb4.Show();
                tbNovTelefon.Show();
            }
            if (cbox.SelectedItem.Equals("Адреса"))
            {
                lb9.Show();
                tbNovaAdresa.Show();
            }
            if (cbox.SelectedItem.Equals("Е-Маил"))
            {
                lb6.Show();
                tbNovEmail.Show();
            }
        ...
        {
            if (tbNovoPrezime.Text != "")
            {
                conn.Open();
                string query = "Update Vraboteni set Prezime=@tbNovoPrezime where VrabotenID = @tbrb";
                SqlCommand cmd = new SqlCommand(query, conn);
                cmd.Parameters.Add("@tbrb", SqlDbType.Int).Value = Convert.ToInt32(tbrb.Text);
                cmd.Parameters.Add("@tbNovoPrezime", tbNovoPrezime.Text);
                cmd.ExecuteNonQuery();
            ...
            {
                conn.Open();
                string query = "Update Vraboteni set [Korisnichko ime]=@tbNovoKIme where VrabotenID = @tbrb";
                SqlCommand cmd = new SqlCommand(query, conn);
                cmd.Parameters.Add("@tbrb", SqlDbType.Int).Value = Convert.ToInt32(tbrb.Text);
                cmd.Parameters.Add("@tbNovoKIme", tbNovoKIme.Text);
                cmd.ExecuteNonQuery();
            ...
            if (tbNovTelefon.Text != "")
            {
                conn.Open();
                string query = "Update Vraboteni set Telefon=@tbNovTelefon where VrabotenID = @tbrb";
                SqlCommand cmd = new SqlCommand(query, conn);
                cmd.Parameters.Add("@tbrb", SqlDbType.Int).Value = Convert.ToInt32(tbrb.Text);
                cmd.Parameters.Add("@tbNovTelefon", tbNovTelefon.Text);
                cmd.ExecuteNonQuery();
            ...
            if (tbNovaAdresa.Text != "")
            {
                conn.Open();
                string query = "Update Vraboteni set Adresa=@tbNovaAdresa where VrabotenID = @tbrb";
                SqlCommand cmd = new SqlCommand(query, conn);
                cmd.Parameters.Add("@tbrb", SqlDbType.Int).Value = Convert.ToInt32(tbrb.Text);
                cmd.Parameters.Add("@tbNovaAdresa", tbNovaAdresa.Text);
                cmd.ExecuteNonQuery();
            ...
            {
                conn.Open();
                string query = "Update Vraboteni set [E-mail]=@tbNovEmail where VrabotenID = @tbrb";
                SqlCommand cmd = new SqlCommand(query, conn);
                cmd.Parameters.Add("@tbrb", SqlDbType.Int).Value = Convert.ToInt32(tbrb.Text);
                cmd.Parameters.Add("@tbNovEmail", tbNovEmail.Text);
                cmd.ExecuteNonQuery();
