...
{
    public partial class Групни_тренизи : Form
    {
        public Групни_тренизи()
        {
            InitializeComponent();
        }
        ...
        private void Групни_тренизи_Load(object sender, EventArgs e)
        {
            this.Width = 1000;
            this.Height = 600;
            this.ShowIcon = false;
            ...
            Label lb1 = new Label();
            lb1.Text = "Приказ на сите типови групни тренинзи";
            lb1.Width = 400;
            lb1.Height = 50;
            ...
            conn.Open();
            dataAdapter = new SqlDataAdapter("select ID AS РеденБрој, Ime AS Име, Cena AS Цена from Grupni_Treninzi", conn);
        ...
        {
            conn.Open();
            SqlCommand sql = new SqlCommand("DELETE FROM Grupni_Treninzi WHERE ID = @tbrb", conn);
        ...
        {
            this.Hide();
            Izmeni_gr_treninzi grtreninzi = new Izmeni_gr_treninzi();
        ...
        {
            this.Hide();
            Dodaj_grupen_trening grtreninzi = new Dodaj_grupen_trening();
            grtreninzi.FormClosed += (s, args) => this.Close();
            grtreninzi.Show();
        }
    }
