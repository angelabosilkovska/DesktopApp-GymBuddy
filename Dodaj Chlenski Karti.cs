...
{
    public partial class Dodaj_Chlenski_Karti : Form
    {
        public Dodaj_Chlenski_Karti()
        {
            InitializeComponent();
        }
        ...
        private void Dodaj_Chlenski_Karti_Load(object sender, EventArgs e)
        {
            this.Width = 1000;
            this.Height = 600;
            this.ShowIcon = false;
            ...
            Label lb1 = new Label();
            lb1.Text = "Додај нов тип членска карта";
            lb1.Width = 300;
            lb1.Height = 50;
        ...
        public void btZachuvaj_Click(object sender, EventArgs e)
        {
            ...
            {
                conn.Open();
                string query = "insert into Chlenski_Karti(ID,Ime,Cena) " +
        ...
        {
            this.Hide();
            Членски_Карти chkarti = new Членски_Карти();
